...
class TestMovieToStremioMeta:
    ...
    def test_with_complete_data(self, sample_tmdb_movie):
        ...
        assert result["description"] == "A ticking-time-bomb insomniac and a slippery soap salesman channel primal male aggression into a shocking new form of therapy."
